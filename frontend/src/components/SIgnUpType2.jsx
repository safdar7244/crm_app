...
return (
    ...
    <input id="entry1" onChange={handleChange} name="nit" type="text" className="" placeholder={props.Entry1} required/>
    <button  className="btn btn-default" id="Vid" onClick={SeeVid} >Show Vid</button>
    <input id="entry2" onChange={handleChange} name="companyName" type="text" className="" placeholder={props.Entry2} required  />
    <input id="entry3" onChange={handleChange} name="contactName"type="text" className="" placeholder={props.Entry3}  required/>
    <input id="entry4" onChange={handleChange} name="email" type="text" className="" placeholder={props.Entry4}  required/>
    <input id="entry5" onChange={handleChange} name="Telephone" type={props.typ} className="" placeholder={props.Entry5}  required/>
    <select id="entry6" onChange={handleChange} name="country" className="custom-select " id={props.UniqId1} required >
        <option defaultValue>{props.Select1} </option>
        <option value={props.Select1_1}>{props.Select1_1}</option>
